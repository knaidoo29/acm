...
def run_marginalised_greedy_fisher(
    statistics, max_bins, fixed_parameters_idx, nuisance_parameters_idx
):
    ...
    bins_marg, _, fisher_marg = run_greedy_fisher(
        statistics,
        max_bins=max_bins, 
        add_emulator_error=True,
        fixed_parameters_idx=fixed_parameters_idx,
...
if __name__ == '__main__':
    ...
    with open(data_path / 'fixed_blcdm_marginalised_hod.json', 'w') as f:
        json.dump(all_fisher, f)
