...
class VIDEVoidSizeFunction(BaseObservable):
    """
    Class for the Emulator's Mock Challenge void size function
    using the VIDE void finder.
    """
    def __init__(self, phase_correction=False, **kwargs):
        self.logger = logging.getLogger(self.__class__.__name__)
        self.stat_name = 'vide_vsf_rsd'
        self.sep_name = 'Rv'
